...
<body>
<%Integer id = Integer.parseInt(application.getAttribute("newUserId").toString()); %>
    ...
    <div class="content-sm">
        <form action=/TP_JEE/handle/<%=id %> method="POST">
            <div class="form-group">
                <label class="oleo-label" for="username">Username</label>
                <input class="form-control rounded-input" type="text" name="username" placeholder="Username" value="">
            </div>
            <div class="form-group">
                <label class="oleo-label" for="firstname">Firstname</label>
                <input class="form-control rounded-input" type="text" name="firstname" placeholder="firstname" value="">
            </div>
            <div class="form-group">
                <label class="oleo-label" for="lastname">Lastname</label>
                <input class="form-control rounded-input" type="text" name="lastname" placeholder="lastname" value="">
            </div>
            <div class="form-group">
                <label class="oleo-label" for="address">Address</label>
                <input class="form-control rounded-input" type="text" name="address" placeholder="address" value="">
            </div>
            <div class="form-group">
                <label class="oleo-label" for="phone">Phone</label>
                <input class="form-control rounded-input" type="text" name="phone" placeholder="phone" value="">
            </div>
            <div class="form-group">
                <label class="oleo-label" for="mail">Mail address</label>
                <input class="form-control rounded-input" type="text" name="mail" placeholder="mail" value="">
            </div>
            <div class="form-group">
